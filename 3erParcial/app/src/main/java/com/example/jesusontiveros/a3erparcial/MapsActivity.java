...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        String[] latylong = coordenadas.split(",");
        String lats=latylong[0];//LATITUD
        String lons=latylong[1];//LONGITUD
        mMap = googleMap;
        ...
        mMap.addMarker(new MarkerOptions().position(sydney).title("Casa de chuy"));
